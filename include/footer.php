    ...
    <div class="tr__footer__wrapper">
        <div class="tr__section__title tr__container">
            ...
            <div class="tr__section__title__right">
                <div class="tr__fadeUp h-20">
                    <a class="button tr__magnetic tr__cursor__hoverable tr__cursor__hoverable__play z-2 mb-0 tr__button__filled" aria-label="Let&#x27;s talk!" target="" href="contact.html">
                        Let&#x27;s talk!<span class="tr__button__background">Let&#x27;s talk!</span>
                    </a>
                </div>
            </div>
        </div>
        <div class="tr__container tr__only__mobile">
            <a class="button tr__magnetic tr__cursor__hoverable tr__cursor__hoverable__play z-2 float-none inline-block m-auto tr__button__filled" aria-label="Let&#x27;s talk!" target="" href="contact.html">
                Let&#x27;s talk!<span class="tr__button__background">Let&#x27;s talk!</span>
            </a>
        </div>
        <div class="tr__container">
            ...
            <div class="tr__footer__contact mt-10 sm:mt-0">
                <div class="tr__footer__contact__block tr__fadeUp">
                    <span>Email</span>
                    <h4 class="overflow-visible"><a class="tr__cursor__hoverable tr__magnetic inline-block" href="mailto:hello@Inkfinity Tech.com">hello@Inkfinity Tech.com</a></h4>
                </div>
                <div class="tr__footer__contact__block tr__fadeUp">
                    <span>Call</span>
                    <h4 class="overflow-visible"><a class="tr__cursor__hoverable tr__magnetic inline-block" href="tel:+919824182099">+91 98241 82099</a></h4>
                </div>
                <div class="tr__footer__contact__block hidden xl:block"></div>
                <div class="tr__footer__contact__block lg:text-right tr__fadeUp">
                    <span>Skype</span>
                    <h4 class="overflow-visible"><a class="tr__cursor__hoverable tr__magnetic inline-block" href="skype:live:.cid.ba18dfcade1479a7?chat">talk.Inkfinity Tech</a></h4>
                </div>
            </div>
            <div class="tr__fadeUp h-8">
        ...
        <div class="tr__container tr__footer__copyright">
            ...
            <div class="tr__footer__copyright__right tr__fadeUp">
                <a aria-label="Inkfinity Tech" class="tr__cursor__hoverable tr__magnetic inline-block" href="index.html">
                    <img alt="Inkfinity Tech" loading="lazy" width="34" height="34" decoding="async" data-nimg="1" style="color: transparent;" src="http://localhost/brand/_next/static/media/move-top.650752b8.svg" />
                </a>
            </div>
        </div>
    </div>
...
<div class="tr__masking tr__cursor__hoverable">
    <div class="tr__masking__wrapper">
        <div class="tr__masking__primary">
            ...
            <img alt="Inkfinity Tech" loading="lazy" width="1440" height="305" decoding="async" data-nimg="1" class="w-full tr__footer__masking" style="color: transparent;" src="http://localhost/brand/_next/static/media/footer-logo.7dd398e2.svg" />
        </div>
...
<section class="tr__section tr__site__loader tr__overlay">
    <div class="tr__container tr__site__loader__container">
        <div class="tr__site__loader__wrapper">
            <div class="w-52 h-52 sm:w-28 sm:h-28 m-auto -mb-6 sm:-mb-3 loader-stagger">
                <div></div>
            </div>
        </div>
...
<canvas id="tr__fluid__anim" class="fixed top-0 left-0 w-screen h-screen mix-blend-lighten z-0"></canvas>
<div>
